import svgPaths from "./svg-xtmd542gzt";
    ...
    <div className="h-[48.2px] relative shrink-0 w-full" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[48.2px] items-center px-[16px] py-[12px] relative w-full">
          <p className="basis-0 font-['Pretendard:Regular',sans-serif] grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#99a1af] text-[14px] tracking-[-0.28px]">전시관 제목을 입력하세요</p>
        </div>
      </div>
    ...
    <div className="h-[111.2px] relative shrink-0 w-full" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[111.2px] items-start px-[16px] py-[12px] relative w-full">
          <p className="basis-0 font-['Pretendard:Regular',sans-serif] grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#99a1af] text-[14px] tracking-[-0.28px]">전시관에 대한 설명을 입력하세요</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[1.6px] border-black border-solid inset-0 pointer-events-none" />
    </div>
...
function Option() {
  return <div className="absolute left-[-404.6px] size-0 top-[-464.8px]" data-name="Option" />;
}

function Dropdown() {
  return (
    <div className="h-[47.2px] relative shrink-0 w-full" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border-[1.6px] border-black border-solid inset-0 pointer-events-none" />
