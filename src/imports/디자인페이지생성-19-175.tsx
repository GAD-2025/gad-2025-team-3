import svgPaths from "./svg-bu6u1ouqfd";
...
function Button() {
  return (
    <div className="absolute bg-black box-border content-stretch flex gap-[12px] h-[53.2px] items-center justify-center left-0 pl-[1.6px] pr-[1.613px] py-[1.6px] top-[206.4px] w-[342px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.6px] border-black border-solid inset-0 pointer-events-none" />
      <Text />
    </div>
  );
