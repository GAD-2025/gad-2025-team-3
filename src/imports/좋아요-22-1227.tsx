import svgPaths from "./svg-vjpdg0lkqq";
...
function Heading() {
  return (
    <div className="h-[35px] relative shrink-0 w-full" data-name="Heading 1">
      <p className="absolute font-['Pretendard:SemiBold',sans-serif] leading-[32px] left-0 not-italic text-[24px] text-black text-nowrap top-[-0.6px] tracking-[-0.48px] whitespace-pre">BTS ARMY 글로벌 전시관</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-full" data-name="Paragraph">
      <p className="font-['Apple_Garamond:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#4a5565] text-[12px] tracking-[0.3px] w-[77px]">by army_forever</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="box-border content-stretch flex items-start justify-center mb-[-4px] relative shrink-0 w-full" data-name="Container">
      <p className="font-['Apple_Garamond:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#4a5565] text-[12px] text-nowrap tracking-[0.3px] whitespace-pre">Room</p>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center justify-center mb-[-4px] relative shrink-0 w-full" data-name="Container">
      <p className="font-['Apple_Garamond:Bold',sans-serif] leading-[28px] not-italic relative shrink-0 text-[18px] text-black text-nowrap whitespace-pre">201</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[16.5px] relative shrink-0 w-[27.4px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[16.5px] relative w-[27.4px]">
        <p className="absolute font-['Apple_Garamond:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[-0.2px] tracking-[0.3px] whitespace-pre">8,900</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[16.5px] relative shrink-0 w-[14.725px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[16.5px] relative w-[14.725px]">
        <p className="absolute font-['Apple_Garamond:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[-0.2px] tracking-[0.3px] whitespace-pre">567</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[16.5px] relative shrink-0 w-[11.325px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[16.5px] relative w-[11.325px]">
        <p className="absolute font-['Apple_Garamond:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#4a5565] text-[12px] text-nowrap top-[-0.2px] tracking-[0.3px] whitespace-pre">89</p>
      </div>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="content-stretch flex gap-[10px] items-end relative shrink-0 w-full" data-name="Heading 3">
      <p className="font-['Apple_Garamond:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#4a5565] text-[16px] text-nowrap whitespace-pre">About</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-full" data-name="Paragraph">
      <p className="font-['Pretendard:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[12px] text-black tracking-[-0.24px] w-[336px]">이 전시관은 팬들의 추억과 사랑을 담은 특별한 공간입니다. 콘서트, 팬미팅, 그리고 일상의 순간들을 함께 나누고 있습니다.</p>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-full" data-name="Heading 3">
      <p className="font-['Apple_Garamond:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#4a5565] text-[16px] text-nowrap whitespace-pre">Gallery</p>
    </div>
  );
}
...
function Heading3() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-full" data-name="Heading 3">
      <p className="font-['Apple_Garamond:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#4a5565] text-[16px] w-[95px]">Comments 3</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[16.5px] relative shrink-0 w-[64.775px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[16.5px] relative w-[64.775px]">
        <p className="absolute font-['Apple_Garamond:Regular',sans-serif] leading-[16px] left-0 not-italic text-[12px] text-black text-nowrap top-[-0.2px] tracking-[0.3px] whitespace-pre">fan_user_123</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[16.5px] relative shrink-0 w-[2.913px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[16.5px] relative w-[2.913px]">
        <p className="absolute font-['Playfair_Display:Regular',sans-serif] font-normal leading-[16.5px] left-0 text-[#99a1af] text-[11px] text-nowrap top-[-0.2px] whitespace-pre">·</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[16.5px] relative shrink-0 w-[39.888px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[16.5px] relative w-[39.888px]">
        <p className="absolute font-['Pretendard:Regular',sans-serif] leading-[18px] left-0 not-italic text-[#99a1af] text-[12px] text-nowrap top-[-0.2px] tracking-[-0.24px] whitespace-pre">2시간 전</p>
      </div>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[-0.2px] tracking-[-0.28px] whitespace-pre">정말 멋진 전시관이에요! 👏</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[16.5px] relative shrink-0 w-[60.875px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[16.5px] relative w-[60.875px]">
        <p className="absolute font-['Apple_Garamond:Regular',sans-serif] leading-[16px] left-0 not-italic text-[12px] text-black text-nowrap top-[-0.2px] tracking-[0.3px] whitespace-pre">music_lover</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[16.5px] relative shrink-0 w-[39.188px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[16.5px] relative w-[39.188px]">
        <p className="absolute font-['Pretendard:Regular',sans-serif] leading-[18px] left-0 not-italic text-[#99a1af] text-[12px] text-nowrap top-[-0.2px] tracking-[-0.24px] whitespace-pre">5시간 전</p>
      </div>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[-0.2px] tracking-[-0.28px] whitespace-pre">추억이 가득하네요 ❤️</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[16.5px] relative shrink-0 w-[47.063px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[16.5px] relative w-[47.063px]">
        <p className="absolute font-['Apple_Garamond:Regular',sans-serif] leading-[16px] left-0 not-italic text-[12px] text-black text-nowrap top-[-0.2px] tracking-[0.3px] whitespace-pre">kpop_fan</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[16.5px] relative shrink-0 w-[28.063px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[16.5px] relative w-[28.063px]">
        <p className="absolute font-['Pretendard:Regular',sans-serif] leading-[18px] left-0 not-italic text-[#99a1af] text-[12px] text-nowrap top-[-0.2px] tracking-[-0.24px] whitespace-pre">1일 전</p>
      </div>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[-0.2px] tracking-[-0.28px] whitespace-pre">저도 가보고 싶어요!</p>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="basis-0 bg-[#f360c0] grow h-[59.2px] min-h-px min-w-px relative shrink-0" data-name="Button">
      <div className="size-full">
...
function Text12() {
  return (
    <div className="content-stretch flex items-start justify-center relative shrink-0" data-name="Text">
      <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-nowrap text-white tracking-[-0.28px] whitespace-pre">코멘트 작성</p>
    </div>
  );
}
...
function Button4() {
  return (
    <div className="basis-0 bg-black grow h-[59px] min-h-px min-w-px relative shrink-0" data-name="Button">
...
function Container31() {
  return (
    <div className="box-border content-stretch flex gap-[12px] h-[107.2px] items-start pb-0 pt-[24px] px-[24px] relative shrink-0 w-[390px]" data-name="Container">
      <Button3 />
      <Button4 />
    </div>
  );
...
export default function Component() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[34px] items-start relative size-full" data-name="좋아요!">
      <Copy />
      <Container31 />
    </div>
  );
