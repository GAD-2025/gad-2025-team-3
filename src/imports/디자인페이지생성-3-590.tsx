import svgPaths from "./svg-2vsedqg662";
...
function Frame() {
  return (
    <div className="box-border content-stretch flex flex-col font-['Pretendard:Regular',sans-serif] gap-[6px] items-center not-italic px-0 py-[14px] relative shrink-0">
      <p className="h-[24px] leading-[24px] relative shrink-0 text-[16px] text-black tracking-[-0.32px] w-[305px]">[필수] 서비스 이용약관 동의</p>
      <div className="leading-[0] relative shrink-0 text-[#4a5565] text-[12px] tracking-[-0.24px] w-[305px]">
        <p className="leading-[18px] mb-0">SHOWCASE 서비스 이용약관</p>
        <p className="leading-[18px] mb-0">{`제1조 (목적) 본 약관은 GAD_3(이하 '회사'라 함)이 제공하는 SHOWCASE 서비스(이하 '서비스'라 함)의 이용과 관련하여 '회사'와 '회원'의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.`}</p>
        <p className="leading-[18px] mb-0">제2조 (용어의 정의)</p>
        <ol className="list-decimal mb-0" start="1">
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'서비스'라 함은 '회사'가 제공하는 SHOWCASE 및 관련 제반 서비스를 의미합니다.`}</span>
          </li>
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'회원'이라 함은 '회사'의 '서비스'에 접속하여 본 약관에 따라 '회사'와 이용계약을 체결하고 '회사'가 제공하는 '서비스'를 이용하는 고객을 말합니다.`}</span>
          </li>
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'아이디(ID)'라 함은 '회원'의 식별과 '서비스' 이용을 위하여 '회원'이 정하고 '회사'가 승인하는 이메일 주소 또는 문자/숫자의 조합을 의미합니다.`}</span>
          </li>
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'비밀번호'라 함은 '회원'이 부여받은 '아이디'와 일치되는 '회원'임을 확인하고 비밀보호를 위해 '회원' 자신이 정한 문자 또는 숫자 등의 조합을 의미합니다.`}</span>
          </li>
          <li className="ms-[18px]">
            <span className="leading-[18px]">{`'게시물'이라 함은 '회원'이 '서비스' 상에 게시한 부호·문자·음성·화상·동영상 등의 정보 형태의 글, 사진, 동영상 및 각종 파일과 링크 등을 의미합니다.`}</span>
          </li>
        </ol>
        <p className="leading-[18px] mb-0">제3조 (약관의 게시와 개정)</p>
        <ol className="list-decimal mb-0" start="1">
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'회사'는 본 약관의 내용을 '회원'이 쉽게 알 수 있도록 서비스 초기 화면 또는 연결화면에 게시합니다.`}</span>
          </li>
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'회사'는 '약관의 규제에 관한 법률', '정보통신망 이용촉진 및 정보보호 등에 관한 법률' 등 관련법을 위배하지 않는 범위에서 본 약관을 개정할 수 있습니다.`}</span>
          </li>
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'회사'가 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 제1항의 방식에 따라 그 개정약관의 적용일자 7일 전부터 적용일자 전일까지 공지합니다. (단, 회원에게 불리한 변경의 경우 30일 전 공지)`}</span>
          </li>
          <li className="ms-[18px]">
            <span className="leading-[18px]">{`'회원'이 개정약관에 동의하지 않는 경우, '회원'은 회원 탈퇴를 할 수 있습니다.`}</span>
          </li>
        </ol>
        <p className="leading-[18px] mb-0">제4조 (회원가입)</p>
        <ol className="list-decimal mb-0" start="1">
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`회원가입은 '서비스'를 이용하려는 자(이하 '가입신청자')가 약관의 내용에 대하여 동의를 한 다음 회원가입신청을 하고 '회사'가 이러한 신청에 대하여 승낙함으로써 체결됩니다.`}</span>
          </li>
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'가입신청자'는 만 14세 이상이어야 하며, '회사'는 만 14세 미만 아동의 회원가입을 제한합니다.`}</span>
          </li>
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'회사'는 다음 각 호에 해당하는 신청에 대하여는 승낙을 하지 않거나 사후에 이용계약을 해지할 수 있습니다.`}</span>
          </li>
          <ul className="list-disc">
            <li className="mb-0 ms-[36px]">
              <span className="leading-[18px]">실명이 아니거나 타인의 명의를 이용한 경우</span>
            </li>
            <li className="mb-0 ms-[36px]">
              <span className="leading-[18px]">{`허위의 정보를 기재하거나, '회사'가 제시하는 내용을 기재하지 않은 경우`}</span>
            </li>
            <li className="ms-[36px]">
              <span className="leading-[18px]">기타 본 약관에 위배되거나 위법 또는 부당한 이용신청임이 확인된 경우</span>
            </li>
          </ul>
        </ol>
        <p className="leading-[18px] mb-0">제5조 (회사의 의무)</p>
        <ol className="list-decimal mb-0" start="1">
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'회사'는 관련 법령과 본 약관이 금지하거나 미풍양속에 반하는 행위를 하지 않으며, 계속적이고 안정적으로 '서비스'를 제공하기 위하여 최선을 다하여 노력합니다.`}</span>
          </li>
          <li className="ms-[18px]">
            <span className="leading-[18px]">{`'회사'는 '회원'의 개인정보(신용정보 포함)를 보호하기 위해 보안 시스템을 갖추어야 하며 개인정보 처리방침을 공시하고 준수합니다.`}</span>
          </li>
        </ol>
        <p className="leading-[18px] mb-0">제6조 (회원의 의무)</p>
        <ol className="list-decimal mb-0" start="1">
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'회원'은 다음 행위를 하여서는 안 됩니다.`}</span>
          </li>
          <ul className="list-disc">
            <li className="mb-0 ms-[36px]">
              <span className="leading-[18px]">회원가입 또는 회원정보 변경 시 허위 내용 등록</span>
            </li>
            <li className="mb-0 ms-[36px]">
              <span className="leading-[18px]">타인의 정보 도용</span>
            </li>
            <li className="mb-0 ms-[36px]">
              <span className="leading-[18px]">{`'회사'가 게시한 정보의 변경`}</span>
            </li>
            <li className="mb-0 ms-[36px]">
              <span className="leading-[18px]">{`'회사'와 기타 제3자의 저작권 등 지적재산권에 대한 침해`}</span>
            </li>
            <li className="mb-0 ms-[36px]">
              <span className="leading-[18px]">{`'회사' 및 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위`}</span>
            </li>
            <li className="ms-[36px]">
              <span className="leading-[18px]">{`외설 또는 폭력적인 메시지, 화상, 음성, 기타 공서양속에 반하는 정보를 '서비스'에 공개 또는 게시하는 행위`}</span>
            </li>
          </ul>
        </ol>
        <p className="leading-[18px] mb-0">제7조 (게시물의 저작권)</p>
        <ol className="list-decimal mb-0" start="1">
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'회원'이 '서비스' 내에 게시한 '게시물'의 저작권은 해당 '게시물'의 저작자에게 귀속됩니다.`}</span>
          </li>
          <li className="ms-[18px]">
            <span className="leading-[18px]">{`'회원'이 '서비스' 내에 게시하는 '게시물'은 '서비스' 및 관련 프로모션 등에 노출될 수 있으며, 해당 노출을 위해 필요한 범위 내에서는 일부 수정, 복제, 편집되어 게시될 수 있습니다.`}</span>
          </li>
        </ol>
        <p className="leading-[18px] mb-0">제8조 (서비스 이용 제한 및 계약 해지)</p>
        <ol className="list-decimal mb-0" start="1">
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'회원'은 언제든지 서비스 내 '회원 탈퇴' 기능을 통하여 이용계약 해지를 신청할 수 있으며, '회사'는 관련법 등이 정하는 바에 따라 이를 즉시 처리하여야 합니다.`}</span>
          </li>
          <li className="ms-[18px]">
            <span className="leading-[18px]">{`'회원'이 본 약관의 의무를 위반하거나 '서비스'의 정상적인 운영을 방해한 경우, '회사'는 경고, 일시정지, 영구이용정지 등으로 '서비스' 이용을 단계적으로 제한할 수 있습니다.`}</span>
          </li>
        </ol>
        <p className="leading-[18px] mb-0">제9조 (면책조항)</p>
        <ol className="list-decimal mb-0" start="1">
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'회사'는 천재지변 또는 이에 준하는 불가항력으로 인하여 '서비스'를 제공할 수 없는 경우에는 '서비스' 제공에 관한 책임이 면제됩니다.`}</span>
          </li>
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'회사'는 '회원'의 귀책사유로 인한 '서비스' 이용의 장애에 대하여는 책임을 지지 않습니다.`}</span>
          </li>
          <li className="ms-[18px]">
            <span className="leading-[18px]">{`'회사'는 '회원' 간 또는 '회원'과 제3자 상호간에 '서비스'를 매개로 하여 거래 등을 한 경우에는 책임이 면제됩니다.`}</span>
          </li>
        </ol>
        <p className="leading-[18px] mb-0">제10조 (준거법 및 재판관할)</p>
        <ol className="list-decimal mb-0" start="1">
          <li className="mb-0 ms-[18px]">
            <span className="leading-[18px]">{`'회사'와 '회원' 간 제기된 소송은 대한민국법을 준거법으로 합니다.`}</span>
          </li>
          <li className="ms-[18px]">
            <span className="leading-[18px]">{`'회사'와 '회원' 간 발생한 분쟁에 관한 소송은 [관할 법원 기재, 예: 서울중앙지방법원]을 관할 법원으로 합니다.`}</span>
          </li>
        </ol>
        <p className="leading-[18px]">부칙 본 약관은 [시행일자, 예: 202X년 XX월 XX일]부터 적용됩니다.</p>
      </div>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col items-center left-[calc(50%-172.5px)] p-px top-[42px] w-[345px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[1.108px] border-black border-solid inset-0 pointer-events-none" />
      <Container14 />
      <Frame />
      <Container15 />
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="디자인 페이지 생성">
      ...
      <Container4 />
      <Container13 />
      <div className="absolute bg-[rgba(0,0,0,0.6)] h-[1951px] left-0 top-0 w-[393px]" />
      <Container16 />
    </div>
  );
}