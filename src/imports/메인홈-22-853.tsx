import svgPaths from "./svg-pgzj2fvihq";
...
function Button3() {
  return (
    <div className="basis-0 grow h-[59.2px] min-h-px min-w-px relative shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.6px] border-black border-solid inset-0 pointer-events-none" />
      <div className="size-full">
...
export default function Component() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[34px] items-start relative size-full" data-name="메인 홈">
      <Copy />
      <Container31 />
    </div>
  );
