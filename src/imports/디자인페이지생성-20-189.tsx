import svgPaths from "./svg-537x0lcjuk";
...
function Button2() {
  return (
    <div className="absolute bg-[#f360c0] box-border content-stretch flex flex-col items-start left-0 p-[1.6px] size-[106px] top-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.6px] border-black border-solid inset-0 pointer-events-none" />
      <Container7 />
    </div>
  );
