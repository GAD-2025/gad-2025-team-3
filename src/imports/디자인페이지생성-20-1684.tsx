import svgPaths from "./svg-3qxuua372c";
...
function Container7() {
  return (
    <div className="basis-0 box-border content-start flex flex-wrap gap-[16px] grow h-full items-start justify-center min-h-px min-w-px pb-[1.6px] pt-[21.6px] px-[1.6px] relative shrink-0" data-name="Container">
