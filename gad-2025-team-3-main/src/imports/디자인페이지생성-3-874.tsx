import svgPaths from "./svg-bz4dv4z5ns";
    ...
    <div className="relative shrink-0 size-[23.99px]" data-name="Container">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Container">
          ...
          <path d={svgPaths.p19947500} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative shrink-0 size-[19.992px]" data-name="Container">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Container">
          ...
          <path d={svgPaths.p2cab4800} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Container13() {
  return (
    <div className="h-[570.221px] relative shrink-0 w-full" data-name="Container">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[23.99px] h-[570.221px] items-start pb-0 pt-[23.99px] px-[23.99px] relative w-full">
          <Container5 />
          <Container12 />
          <Button6 />
        </div>
