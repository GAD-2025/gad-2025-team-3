const ARTISTS = [
  ...
  { id: 'nctdream', name: 'NCT_Dream', type: 'group' },
  { id: 'txt', name: 'TXT', type: 'group' },
  { id: 'twice', name: 'TWICE', type: 'group' },
  { id: 'redvelvet', name: 'RedVelvet', type: 'group' },
  ...
  { id: 'straykids', name: 'Stray_Kids', type: 'group' },
  { id: 'wayv', name: 'Way_V', type: 'group' },
  { id: 'snsd', name: '소녀시대', type: 'group' },
  { id: 'nctwish', name: 'NCT_WISH', type: 'group' },
  ...
  { id: 'plave', name: 'PLAVE', type: 'group' },
  { id: 'triples', name: 'tripleS', type: 'group' },
];
