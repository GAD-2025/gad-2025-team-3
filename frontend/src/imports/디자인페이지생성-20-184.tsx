import svgPaths from "./svg-e6stpbylbu";
...
function Button3() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-start left-[0.38px] p-[1.6px] size-[106px] top-[117.95px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.6px] border-black border-solid inset-0 pointer-events-none" />
      <Container8 />
    </div>
  );
...
function Button4() {
  return (
    <div className="absolute bg-[#f360c0] box-border content-stretch flex flex-col items-start left-[0.38px] p-[1.6px] size-[106px] top-[235.95px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.6px] border-black border-solid inset-0 pointer-events-none" />
      <Container9 />
    </div>
  );
