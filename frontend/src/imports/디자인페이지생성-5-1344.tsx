import svgPaths from "./svg-q1ym24wvoh";
...
function Button1() {
  return (
    <div className="[grid-area:1_/_1] h-[54px] relative shrink-0" data-name="Button">
...
function Button6() {
  return (
    <div className="[grid-area:3_/_2] h-[53px] relative shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.108px] border-black border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
...
function Button9() {
  return (
    <div className="[grid-area:5_/_1] h-[54px] relative shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.108px] border-black border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
...
function Button14() {
  return (
    <div className="[grid-area:7_/_2] h-[53px] relative shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.108px] border-black border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
...
function Button15() {
  return (
    <div className="[grid-area:8_/_1] h-[54px] relative shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.108px] border-black border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
