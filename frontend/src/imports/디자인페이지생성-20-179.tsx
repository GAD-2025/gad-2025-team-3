import svgPaths from "./svg-0lqjwswkyp";
...
function Heading() {
  return (
    <div className="h-[49px] relative shrink-0 w-[277px]" data-name="Heading 2">
      <p className="absolute font-['Apple_Garamond:Bold',sans-serif] leading-[48px] left-0 not-italic text-[48px] text-black text-nowrap top-[0.89px] whitespace-pre">SHOWCASE</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="basis-0 font-['Pretendard:Regular',sans-serif] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#4a5565] text-[12px] tracking-[-0.24px]">나만의 팬 쇼케이스를 만들어 보세요 !</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-[30.638px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[10px] items-center justify-center relative w-[30.638px]">
        <p className="font-['Apple_Garamond:Bold',sans-serif] leading-[36px] not-italic relative shrink-0 text-[30px] text-black w-full">04</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[18px] relative shrink-0 w-[47.575px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[18px] relative w-[47.575px]">
        <p className="absolute font-['Pretendard:Regular',sans-serif] leading-[18px] left-[-0.14px] not-italic text-[12px] text-black text-nowrap top-[0.04px] tracking-[-0.24px] whitespace-pre">둘러보기</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-start left-[119.38px] p-[1.6px] size-[224px] top-[-0.05px]" data-name="Button">
  ...
  return (
    <div className="h-[42px] mb-[-6px] relative shrink-0 w-[27.163px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[42px] relative w-[27.163px]">
        <p className="absolute font-['Apple_Garamond:Bold',sans-serif] leading-[36px] left-0 not-italic text-[30px] text-black text-nowrap top-[-1.4px] whitespace-pre">01</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="mb-[-6px] relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[10px] items-center justify-center relative">
        <div className="font-['Pretendard:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[12px] text-black text-center text-nowrap tracking-[-0.24px] whitespace-pre">
          <p className="mb-0">나의</p>
          <p>전시관</p>
        </div>
      </div>
    </div>
...
function Button2() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-start left-0 p-[1.6px] size-[106px] top-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.6px] border-black border-solid inset-0 pointer-events-none" />
      <Container7 />
    </div>
  );
  ...
  return (
    <div className="h-[42px] mb-[-6px] relative shrink-0 w-[30.212px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[42px] relative w-[30.212px]">
        <p className="absolute font-['Apple_Garamond:Bold',sans-serif] leading-[36px] left-0 not-italic text-[30px] text-black text-nowrap top-[-1.4px] whitespace-pre">02</p>
      </div>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="absolute bg-[#f360c0] box-border content-stretch flex flex-col items-start left-[0.38px] p-[1.6px] size-[106px] top-[117.95px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.6px] border-black border-solid inset-0 pointer-events-none" />
      <Container8 />
    </div>
  );
  ...
  return (
    <div className="h-[42px] mb-[-6px] relative shrink-0 w-[29.438px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[42px] relative w-[29.438px]">
        <p className="absolute font-['Apple_Garamond:Bold',sans-serif] leading-[36px] left-0 not-italic text-[30px] text-black text-nowrap top-[-1.4px] whitespace-pre">03</p>
      </div>
    </div>
  );
}
...
function Button4() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-start left-[0.38px] p-[1.6px] size-[106px] top-[235.95px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.6px] border-black border-solid inset-0 pointer-events-none" />
      <Container9 />
    </div>
  );
