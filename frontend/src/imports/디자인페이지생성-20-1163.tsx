import svgPaths from "./svg-t5ywzs715v";
...
function Button2() {
  return (
    <div className="bg-[#f360c0] box-border content-stretch flex flex-col h-[163px] items-center justify-center px-[1.6px] py-0 relative shrink-0 w-[162.874px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.6px] border-black border-solid inset-0 pointer-events-none" />
      <Container13 />
    </div>
  );
...
function Frame() {
  return (
    <div className="[grid-area:1_/_1_/_auto_/_span_2] content-start flex flex-wrap gap-[16px] items-start relative self-start shrink-0">
      <Button1 />
      <Button2 />
      <Button3 />
      <Button4 />
