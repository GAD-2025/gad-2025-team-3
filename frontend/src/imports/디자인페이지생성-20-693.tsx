import svgPaths from "./svg-cv3j1aafl9";
  ...
  return (
    <div className="relative shrink-0 size-[80px]" data-name="profile">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
        <g clipPath="url(#clip0_20_724)" id="profile">
    ...
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[30px] py-px relative w-full">
          <p className="font-['Apple_Garamond:Bold',sans-serif] leading-[28px] not-italic relative shrink-0 text-[20px] text-center text-nowrap text-white whitespace-pre">89</p>
        </div>
      </div>
    </div>
  );
...
function Container15() {
  return (
    <div className="content-stretch flex items-start opacity-90 relative shrink-0" data-name="Container">
      <p className="font-['Pretendard:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[12px] text-center text-white tracking-[-0.24px] w-[78.8px]">전체 공유수</p>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="absolute box-border content-stretch flex h-[56.2px] items-center justify-between left-[24px] pl-[17.6px] pr-[266.812px] py-[1.6px] top-[186.4px] w-[342px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.6px] border-black border-solid inset-0 pointer-events-none" />
      <Text9 />
    </div>
  );
